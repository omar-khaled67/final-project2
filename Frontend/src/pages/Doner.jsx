        ...
        <div className="flex justify-center items-center mim-h-screen">
            ...
            <div className="m-[20px] p-[20px] h-[80vh] w-[450px]">
                ...
                <div className="flex flex-col my-[12px]">
                    ...
                    <input type="text" placeholder="James Doe"
                        className="
                        border-b-[#555] border-b-2 border-solid
                        outline-none
                    p-[10px] w-[300px]"/>
                    <label htmlFor="">Address</label>
                    <input type="text" placeholder="123 DownTown, NewYork"
                        className="border-b-[#555] border-b-2 border-solid
                        outline-none
                    p-[10px] w-[300px]"/>
                    ...
                    <input type="text" placeholder="(023) 241 1234"
                        ...
                        outline-none
                    p-[10px] w-[300px]"/>
                    <label htmlFor="" className=''>Blood Group</label>
                    <select name="" id="" className='border-b-[#555] border-b-2 border-solid
                        outline-none
                    p-[10px] w-[300px]'>
            ...
            <div className="m-[20px] p-[20px] h-[80vh] w-[450px]">
                <div className="flex flex-col">
                    ...
                    <textarea name="" id="" className='border-b-[#555] border-b-2 border-solid
                        outline-none
                    p-[10px] w-[300px]' />
                    <button className="bg-[#444] cursor-pointer
                    text-white p-[10px] w-[300px] my-[10px]">Edit</button>
                </div>
            </div>
        </div>
    )
